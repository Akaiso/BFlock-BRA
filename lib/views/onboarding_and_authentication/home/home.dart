              ...
              child: Column(
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: <IconButton>[
                      IconButton(onPressed: (){}, icon: const Icon(Icons.home_outlined, color: Colors.black26,size: 30,)),
                      IconButton(onPressed: (){}, icon: Image.asset('assets/openbook.png',)),
                      IconButton(onPressed: (){}, icon: Image.asset('assets/Combined Shape.png',)),
                      IconButton(onPressed: (){}, icon: Image.asset('assets/ellipsis.png',)),
